...
// const MyTechCard: React.FC<TechCardProps> = ({ className = "", style = {} }) => {
//   return (
//     <CardWrapper>
//       <div
//         className={`bg-[#1a1b1e] text-white rounded-2xl p-4 h-full flex flex-col gap-4 ${className}`}
//         style={{
//           width: "100%",
//           height: "100%",
//           minHeight: "100%",
...
//             </div>
//             {/* Online Status Badge */}
//             <div className="absolute bottom-0 right-0 w-8 h-8 rounded-full border-4 border-[#1a1b1e] bg-green-500" />
//           </div>
//           {/* Discord Icon */}
//           <div className="absolute top-4 right-4 bg-[#e4d8b4] p-4 rounded-full shadow-md">
//             <FaDiscord size={50} className="text-black" />
//           </div>
//         </div>
...
//             <div
//               key={i}
//               className="w-8 h-8 bg-zinc-800 rounded-md flex items-center justify-center text-gray-400"
//             >
//               B{i}
//             </div>
//           ))}
...
//           <h2 className="text-2xl font-bold">enscribe</h2>
//           <p className="text-gray-400 text-sm">@enscribe</p>
//         </div>

//         {/* Status Section */}
//         <div className="flex items-center justify-between bg-[#111214] rounded-lg p-4">
//           <div className="flex items-center gap-3">
//             <div className="w-12 h-12 rounded-md bg-gray-700" />
//             <div>
//               <h3 className="text-lg font-semibold">No status!</h3>
//               <p className="text-sm text-gray-400">Offline</p>
//             </div>
//           </div>
//           <div className="text-right">
//             <p className="text-sm text-gray-400">Last activity:</p>
//             <p className="text-gray-300 text-md">10 mins ago</p>
//           </div>
//         </div>
//       </div>
//     </CardWrapper>
